...
Product.create!([
  ...
  { name: 'Klej do dociepleń', price: 150.99, available_quantity: 10_000, product_category: construction_chemicals_category, picture_key: 'images/products/constuction_chemicals/klej_do_dociepleń.png', picture_bucket: Rails.application.config.x.aws_bucket },
  ...
  { name: 'Tynk akrylowy', price: 120.99, available_quantity: 10_000, product_category: construction_chemicals_category, picture_key: 'images/products/constuction_chemicals/tynk akrylowy.jpeg', picture_bucket: Rails.application.config.x.aws_bucket, promoted_from: PROMOTED_FROM, promoted_to: PROMOTED_TO },
  ...
  { name: 'Taśma kalenicowa', price: 55.00, available_quantity: 0, product_category: roof_zone_category, picture_key: 'images/products/roof_accessories/tasma_kalenicowa.jpeg', picture_bucket: Rails.application.config.x.aws_bucket }, # TODO
  ...
  { name: 'Dalmierz PRO laserowy', price: 359.99, available_quantity: 10_000, product_category: tools_category, picture_key: 'images/products/tools/Dalmierz PRO laserowy.jpeg', picture_bucket: Rails.application.config.x.aws_bucket },
  { name: 'Poziomica PRO', price: 220.99, available_quantity: 10_000, product_category: tools_category, picture_key: 'images/products/tools/Poziomica PRO.jpeg', picture_bucket: Rails.application.config.x.aws_bucket, promoted_from: PROMOTED_FROM, promoted_to: PROMOTED_TO },
  { name: 'Kątowniki montażowe do schodów strychowych', price: 799.99, available_quantity: 10_000, product_category: stairway_category, picture_key: 'images/products/stairway/Kątowniki montażowe do schodów strychowych.png', picture_bucket: Rails.application.config.x.aws_bucket },
  { name: 'Listwa wykończeniowa Fakro', price: 200.50, available_quantity: 10_000, product_category: stairway_category, picture_key: 'images/products/stairway/Listwa wykończeniowa Fakro.jpeg', picture_bucket: Rails.application.config.x.aws_bucket },
  { name: 'Schody strychowe', price: 1300.00, available_quantity: 10_000, product_category: stairway_category, picture_key: 'images/products/stairway/Schody strychowe.jpeg', picture_bucket: Rails.application.config.x.aws_bucket },
  { name: 'Segment przesuwny', price: 150.00, available_quantity: 10_000, product_category: stairway_category, picture_key: 'images/products/stairway/Segment przesuwny.jpeg', picture_bucket: Rails.application.config.x.aws_bucket }
])
